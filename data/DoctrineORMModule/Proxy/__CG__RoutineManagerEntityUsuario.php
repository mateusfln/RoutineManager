 ...
 */
class Usuario extends \RoutineManager\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RoutineManager\\Entity\\Usuario' . "\0" . 'tarefas', 'id', 'nome', 'email', 'password', 'salt'];
        }
